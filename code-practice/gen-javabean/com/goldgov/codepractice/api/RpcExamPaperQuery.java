...
public class RpcExamPaperQuery implements org.apache.thrift.TBase<RpcExamPaperQuery, RpcExamPaperQuery._Fields>, java.io.Serializable, Cloneable, Comparable<RpcExamPaperQuery> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RpcExamPaperQuery");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new RpcExamPaperQueryStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new RpcExamPaperQueryTupleSchemeFactory();
  ...
  private java.util.List<RpcExamPaper> resultList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RpcExamPaperQuery.class, metaDataMap);
  }

  public RpcExamPaperQuery() {
    this.pageSize = 15;
  ...
  public RpcExamPaperQuery(
    ...
    int minPage,
    int firstResult,
    java.util.List<RpcExamPaper> resultList)
  {
    this();
   ...
   */
  public RpcExamPaperQuery(RpcExamPaperQuery other) {
    ...
    if (other.isSetResultList()) {
      java.util.List<RpcExamPaper> __this__resultList = new java.util.ArrayList<RpcExamPaper>(other.resultList.size());
      for (RpcExamPaper other_element : other.resultList) {
        __this__resultList.add(new RpcExamPaper(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public RpcExamPaperQuery deepCopy() {
    return new RpcExamPaperQuery(this);
  }
  ...
  public java.util.Iterator<RpcExamPaper> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(RpcExamPaper elem) {
    if (this.resultList == null) {
      this.resultList = new java.util.ArrayList<RpcExamPaper>();
    }
    this.resultList.add(elem);
  }

  public java.util.List<RpcExamPaper> getResultList() {
    return this.resultList;
  }

  public void setResultList(java.util.List<RpcExamPaper> resultList) {
    this.resultList = resultList;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((java.util.List<RpcExamPaper>)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof RpcExamPaperQuery)
      return this.equals((RpcExamPaperQuery)that);
    return false;
  }

  public boolean equals(RpcExamPaperQuery that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(RpcExamPaperQuery other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("RpcExamPaperQuery(");
    boolean first = true;
  ...
  private static class RpcExamPaperQueryStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public RpcExamPaperQueryStandardScheme getScheme() {
      return new RpcExamPaperQueryStandardScheme();
    }
  }

  private static class RpcExamPaperQueryStandardScheme extends org.apache.thrift.scheme.StandardScheme<RpcExamPaperQuery> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RpcExamPaperQuery struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new java.util.ArrayList<RpcExamPaper>(_list0.size);
                RpcExamPaper _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new RpcExamPaper();
                  _elem1.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RpcExamPaperQuery struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (RpcExamPaper _iter3 : struct.resultList)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class RpcExamPaperQueryTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public RpcExamPaperQueryTupleScheme getScheme() {
      return new RpcExamPaperQueryTupleScheme();
    }
  }

  private static class RpcExamPaperQueryTupleScheme extends org.apache.thrift.scheme.TupleScheme<RpcExamPaperQuery> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RpcExamPaperQuery struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (RpcExamPaper _iter4 : struct.resultList)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RpcExamPaperQuery struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.resultList = new java.util.ArrayList<RpcExamPaper>(_list5.size);
          RpcExamPaper _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new RpcExamPaper();
            _elem6.read(iprot);
