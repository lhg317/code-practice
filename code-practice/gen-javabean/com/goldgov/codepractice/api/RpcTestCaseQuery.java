...
public class RpcTestCaseQuery implements org.apache.thrift.TBase<RpcTestCaseQuery, RpcTestCaseQuery._Fields>, java.io.Serializable, Cloneable, Comparable<RpcTestCaseQuery> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RpcTestCaseQuery");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new RpcTestCaseQueryStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new RpcTestCaseQueryTupleSchemeFactory();
  ...
  private java.util.List<RpcTestCase> resultList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RpcTestCaseQuery.class, metaDataMap);
  }

  public RpcTestCaseQuery() {
    this.pageSize = 15;
  ...
  public RpcTestCaseQuery(
    ...
    int minPage,
    int firstResult,
    java.util.List<RpcTestCase> resultList)
  {
    this();
   ...
   */
  public RpcTestCaseQuery(RpcTestCaseQuery other) {
    ...
    if (other.isSetResultList()) {
      java.util.List<RpcTestCase> __this__resultList = new java.util.ArrayList<RpcTestCase>(other.resultList.size());
      for (RpcTestCase other_element : other.resultList) {
        __this__resultList.add(new RpcTestCase(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public RpcTestCaseQuery deepCopy() {
    return new RpcTestCaseQuery(this);
  }
  ...
  public java.util.Iterator<RpcTestCase> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(RpcTestCase elem) {
    if (this.resultList == null) {
      this.resultList = new java.util.ArrayList<RpcTestCase>();
    }
    this.resultList.add(elem);
  }

  public java.util.List<RpcTestCase> getResultList() {
    return this.resultList;
  }

  public void setResultList(java.util.List<RpcTestCase> resultList) {
    this.resultList = resultList;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((java.util.List<RpcTestCase>)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof RpcTestCaseQuery)
      return this.equals((RpcTestCaseQuery)that);
    return false;
  }

  public boolean equals(RpcTestCaseQuery that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(RpcTestCaseQuery other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("RpcTestCaseQuery(");
    boolean first = true;
  ...
  private static class RpcTestCaseQueryStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public RpcTestCaseQueryStandardScheme getScheme() {
      return new RpcTestCaseQueryStandardScheme();
    }
  }

  private static class RpcTestCaseQueryStandardScheme extends org.apache.thrift.scheme.StandardScheme<RpcTestCaseQuery> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RpcTestCaseQuery struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new java.util.ArrayList<RpcTestCase>(_list0.size);
                RpcTestCase _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new RpcTestCase();
                  _elem1.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RpcTestCaseQuery struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (RpcTestCase _iter3 : struct.resultList)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class RpcTestCaseQueryTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public RpcTestCaseQueryTupleScheme getScheme() {
      return new RpcTestCaseQueryTupleScheme();
    }
  }

  private static class RpcTestCaseQueryTupleScheme extends org.apache.thrift.scheme.TupleScheme<RpcTestCaseQuery> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RpcTestCaseQuery struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (RpcTestCase _iter4 : struct.resultList)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RpcTestCaseQuery struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.resultList = new java.util.ArrayList<RpcTestCase>(_list5.size);
          RpcTestCase _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new RpcTestCase();
            _elem6.read(iprot);
