...
public class RpcExerciseQuery implements org.apache.thrift.TBase<RpcExerciseQuery, RpcExerciseQuery._Fields>, java.io.Serializable, Cloneable, Comparable<RpcExerciseQuery> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RpcExerciseQuery");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new RpcExerciseQueryStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new RpcExerciseQueryTupleSchemeFactory();
  ...
  private java.util.List<RpcExercise> resultList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RpcExerciseQuery.class, metaDataMap);
  }

  public RpcExerciseQuery() {
    this.pageSize = 15;
  ...
  public RpcExerciseQuery(
    ...
    int minPage,
    int firstResult,
    java.util.List<RpcExercise> resultList)
  {
    this();
   ...
   */
  public RpcExerciseQuery(RpcExerciseQuery other) {
    ...
    if (other.isSetResultList()) {
      java.util.List<RpcExercise> __this__resultList = new java.util.ArrayList<RpcExercise>(other.resultList.size());
      for (RpcExercise other_element : other.resultList) {
        __this__resultList.add(new RpcExercise(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public RpcExerciseQuery deepCopy() {
    return new RpcExerciseQuery(this);
  }
  ...
  public java.util.Iterator<RpcExercise> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(RpcExercise elem) {
    if (this.resultList == null) {
      this.resultList = new java.util.ArrayList<RpcExercise>();
    }
    this.resultList.add(elem);
  }

  public java.util.List<RpcExercise> getResultList() {
    return this.resultList;
  }

  public void setResultList(java.util.List<RpcExercise> resultList) {
    this.resultList = resultList;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((java.util.List<RpcExercise>)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof RpcExerciseQuery)
      return this.equals((RpcExerciseQuery)that);
    return false;
  }

  public boolean equals(RpcExerciseQuery that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(RpcExerciseQuery other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("RpcExerciseQuery(");
    boolean first = true;
  ...
  private static class RpcExerciseQueryStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public RpcExerciseQueryStandardScheme getScheme() {
      return new RpcExerciseQueryStandardScheme();
    }
  }

  private static class RpcExerciseQueryStandardScheme extends org.apache.thrift.scheme.StandardScheme<RpcExerciseQuery> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RpcExerciseQuery struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new java.util.ArrayList<RpcExercise>(_list0.size);
                RpcExercise _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new RpcExercise();
                  _elem1.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RpcExerciseQuery struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (RpcExercise _iter3 : struct.resultList)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class RpcExerciseQueryTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public RpcExerciseQueryTupleScheme getScheme() {
      return new RpcExerciseQueryTupleScheme();
    }
  }

  private static class RpcExerciseQueryTupleScheme extends org.apache.thrift.scheme.TupleScheme<RpcExerciseQuery> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RpcExerciseQuery struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (RpcExercise _iter4 : struct.resultList)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RpcExerciseQuery struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.resultList = new java.util.ArrayList<RpcExercise>(_list5.size);
          RpcExercise _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new RpcExercise();
            _elem6.read(iprot);
